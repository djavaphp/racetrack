			...
			<ol class="property-list registration">
				...
				<li class="fieldcontain">
					<span id="race-label" class="property-label"><g:message code="registration.race.label" default="Race" /></span>
						...
						<span class="property-value" aria-labelledby="race-label"><g:link controller="race" action="show" id="${registrationInstance?.race?.id}">${registrationInstance?.race?.name?.encodeAsHTML()}</g:link></span>
