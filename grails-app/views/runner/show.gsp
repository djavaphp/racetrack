...
<html>
	...
	<body>
	<g:link url="http://localhost:9090/racetrack/changePassword">Change Password</g:link>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<shiro:hasPermission permission="runner:list">
		...
		<div id="show-runner" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<shiro:hasPermission permission="runner:delete">
