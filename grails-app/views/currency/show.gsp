	...
	<body>
		...
		<div id="show-currency" class="content scaffold-show" role="main">
			...
			<ol class="property-list currency">
				...
				<g:if test="${currencyInstance?.country}">
				<li class="fieldcontain">
					<span id="country-label" class="property-label"><g:message code="currency.country.label" default="Country" /></span>
					
						<span class="property-value" aria-labelledby="country-label"><g:fieldValue bean="${currencyInstance}" field="country"/></span>
